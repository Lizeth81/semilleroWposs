...
import com.example.decode.databinding.FragmentAlertaDialogoBinding;


public class AlertaDialogoFragment extends DialogFragment {

    private FragmentAlertaDialogoBinding binding;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        binding = FragmentAlertaDialogoBinding.inflate(getLayoutInflater(), null, false);
        ...
        builder.setView(binding.getRoot())
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Toast.makeText(getContext(), "Exelente!!!", Toast.LENGTH_SHORT).show();
                    }
                });
